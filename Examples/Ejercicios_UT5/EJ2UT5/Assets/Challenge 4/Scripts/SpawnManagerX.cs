...
public class SpawnManagerX : MonoBehaviour
{
    ...
    /// </summary>
    /// <param name="enemiesToSpawn">Number of enemies to instantiate</param>
    void SpawnEnemyWave(int enemiesToSpawn)
    {
        ...
        if(isPlayerReset) ResetPlayerPosition(); // put player back at start
    }
